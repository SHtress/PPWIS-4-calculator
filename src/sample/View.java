...
public class View {
    ...
    public View() {
        final int STAGE_WIDTH = 300,
                STAGE_HEIGHT = 300;
        final String STAGE_TITLE_TEXT = "Lab4";
        initWindow();
    ...
    public void initWindow() {
        ...
        Button buttonRemove = new Button("C");
        Button buttonPlus = new Button("+");
        Button buttonMinus = new Button("-");
        Button buttonBracketOpen = new Button("(");
        Button buttonBracketClose = new Button(")");
        Button buttonPercent = new Button("%");
        Button buttonInverse = new Button("inverse");
        Button buttonSqrt = new Button("sqrt");
        Button buttonPow = new Button("pow");
        Button buttonCalculate = new Button("=");
        Button buttonMultiply = new Button("*");
        Button buttonDivision = new Button("/");
        CheckBox trig = new CheckBox("trig");
        TreeView tree = new TreeView();
        TextField formulaField = new TextField(controller.getFormula());
        formulaField.setEditable(false);
        HBox firstRowButtons = new HBox(button1, button2, button3, buttonPlus, buttonBracketOpen, buttonSqrt, trig);
        HBox secondRowButtons = new HBox(button4, button5, button6, buttonMinus, buttonBracketClose);
        HBox thirdRowButtons = new HBox(button7, button8, button9, buttonCalculate, buttonPercent, buttonMultiply);
        HBox fourthRowButtons = new HBox(button0, buttonComma, buttonClear, buttonRemove, buttonInverse, buttonDivision);
        box = new VBox(formulaField, firstRowButtons, secondRowButtons, thirdRowButtons, fourthRowButtons, tree);
        scene = new Scene(box);
        stage.setScene(scene);
        ...
        buttonComma.setOnAction(actionEvent -> {
            addSymbol(",");
        });
        ...
        buttonBracketOpen.setOnAction(actionEvent -> {
            addSymbol("(");
        });
        buttonBracketClose.setOnAction(actionEvent -> {
            addSymbol(")");
        });
        buttonPercent.setOnAction(actionEvent -> {
            addSymbol("%(");
        });
        buttonInverse.setOnAction(actionEvent -> {
            addSymbol("inverse(");
        });
        buttonSqrt.setOnAction(actionEvent -> {
            addSymbol("sqrt(");
        });
